...
public class Class4 {
	...
	public static void main(String[] args) {
		...
		//객체 : Member
        //mb : 인스턴스
		//new Member() : 메모리에 인스턴스명을 생성하여 사용할 수 있도록함
	    mb.user_age = 33;
	    ...
	    //member인스턴스 필드값을 로드함 -> agree라는 필드 상수값으로 전달
	    mb.user_agree = 80; //메모리에 등록된 필드명에 해당 되는 값을 변경
...
class Member{  //클래스 
    ...
    public void member_event() {
		...
		//단, event라는 메소드에 변수 필드 및 변수 필드값을 class에 선언하게 되면 그때는 객체+인스턴스를 생성해야만 로드가 됩니다.
	}
}
